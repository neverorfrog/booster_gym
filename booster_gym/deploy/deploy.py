...
from booster_gym.deploy.utils.command import create_prepare_cmd, create_first_frame_rl_cmd
from booster_gym.deploy.utils.remote_control_service import RemoteControlService
from booster_gym.deploy.utils.rotate import rotate_vector_inverse_rpy
from booster_gym.deploy.utils.timer import TimerConfig, Timer
from booster_gym.deploy.utils.policy import Policy
...
def main():
    ...
    cfg_file = os.path.join("booster_gym/deploy/configs", args.config)
    print(cfg_file)
